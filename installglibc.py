...
def scripts():
    os.system("wget https://raw.githubusercontent.com/neighbor-bear/darkos/main/update-darkos.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/neighbor-bear/darkos/main/debug-darkos.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/neighbor-bear/darkos/main/setting-darkos.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/neighbor-bear/darkos/main/photo.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/neighbor-bear/darkos/main/darkos &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/neighbor-bear/darkos/main/run-darkos.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/neighbor-bear/darkos/main/darkos.py &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/Winetricks/winetricks/master/src/winetricks &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/neighbor-bear/darkos/main/cpu_boost.py &>/dev/null")
